...
let html_point3 = document.getElementById("player3-point");
let html_point4 = document.getElementById("player4-point");
let player1Point = 0;
let player2Point = 0;
let player3Point = 0;
let player4Point = 0;
...
let html_player3turn = document.getElementById("player3-turn");
let html_player4turn = document.getElementById("player4-turn");
let remaining = 26;
...
function finish() {
    if (remaining <= 0) {
        if (player1Point > player2Point && player1Point > player3Point && player1Point > player4Point) {
            open("one-win.html", "_blank");
        }
        else if (player2Point > player1Point && player2Point > player3Point && player2Point > player4Point) {
            open("two-win.html", "_blank");
        }
        else if (player3Point > player1Point && player3Point > player2Point && player3Point > player4Point) {
            open("three-win.html", "_blank");
        }
        else if (player4Point > player1Point && player4Point > player2Point && player4Point > player3Point) {
            open("four-win.html", "_blank");
        }
        else {
        ...
        switch (player) {
                ...
                if (firstCard == 0) {                                           /* １枚目クリック */
                    ...
                    if (firstCard + 13 == html_card[a].value || firstCard - 13 == html_card[a].value) {       /* カードが一致したとき */
                        ...
                        setTimeout(function () {                                                              /* １秒後カードを裏返しにする */
                            ...
                            html_player3turn.classList.add("player3-turn");
                        }, 700);
            ...
            case 3:
                ...
                if (firstCard == 0) {                                           /* １枚目クリック */
                    ...
                    if (firstCard + 13 == html_card[a].value || firstCard - 13 == html_card[a].value) {       /* カードが一致したとき */
                        player3Point += 1;
                        html_point3.innerHTML = player3Point + "ポイント";
                        html_card[a].src = "img/" + html_card[a].value + ".png";                              /* ２枚目表にする */
                        setTimeout(function () {                                                              /* ２秒後カードをなくす */
                            html_card[a].remove();
                            html_card[touchCardNumber].remove()
                        ...
                        setTimeout(function () {                                                              /* １秒後カードを裏返しにする */
                            ...
                            html_card[a].src = "img/card-reverse.png";                                        /* ２枚目 */
                            firstCard = 0;
                            html_player3turn.classList.remove("player3-turn");
                            html_player4turn.classList.add("player4-turn");
                        }, 700);
            ...
            case 4:
                ...
                if (firstCard == 0) {                                           /* １枚目クリック */
                    ...
                    if (firstCard + 13 == html_card[a].value || firstCard - 13 == html_card[a].value) {       /* カードが一致したとき */
                        player4Point += 1;
                        html_point4.innerHTML = player4Point + "ポイント";
                        html_card[a].src = "img/" + html_card[a].value + ".png";                              /* ２枚目表にする */
                        setTimeout(function () {                                                              /* ２秒後カードをなくす */
                            html_card[a].remove();
                            html_card[touchCardNumber].remove()
                        ...
                        setTimeout(function () {                                                              /* １秒後カードを裏返しにする */
                            ...
                            html_card[a].src = "img/card-reverse.png";                                        /* ２枚目 */
                            firstCard = 0;
                            html_player4turn.classList.remove("player4-turn");
                            html_player1turn.classList.add("player1-turn");
                        }, 700);
